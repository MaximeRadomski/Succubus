...
public static class AndroidNativeAudio
{
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "load(\"" + audioFile + "\", " + usePersistentDataPath + "\", " + callback + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "makePool(" + maxStreams + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "pause(" + streamID + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "play(" + fileID + ", " + leftVolume + ", " + rightVolume + ", " + priority + ", " + loop + ", " + rate + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "releasePool()");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "resume(" + streamID + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "resumeAll()");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "setLoop(" + streamID + ", " + loop + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "setPriority(" + streamID + ", " + priority + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "setRate(" + streamID + ", " + rate + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "setVolume(" + streamID + ", " + leftVolume + ", " + rightVolume + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "stop(" + streamID + ")");
	...
	{
		if (DEBUG)
			CustomLog(_logPrefix + "unload(" + fileID + ")");
    ...
    private static void CustomLog(string log)
    {
        //CustomLog(log);
    }
