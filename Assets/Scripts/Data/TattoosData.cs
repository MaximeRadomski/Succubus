...
public static class TattoosData
{
    ...
    public static string[] Tattoos =
        ...
        "Eclipse Glasses", "Crown Of Thorns", "Perfect Score" };

    public static string[] CommonTattoosNames = { Tattoos[0], Tattoos[1], Tattoos[4], Tattoos[9], Tattoos[10], Tattoos[11], Tattoos[12], Tattoos[13], Tattoos[17], Tattoos[20] };
    ...
    public static Tattoo DebugTattoo = GetTattooFromName("Crown Of Thorns");
