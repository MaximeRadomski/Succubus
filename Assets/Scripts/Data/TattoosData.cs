...
public static class TattoosData
{
    ...
    /* 40 */ "Brand of Sacrifice", "Beer", "Loot Box", "Family Tree", "Star", "Infinite Stairs", "Blood Eye"};
    ...
    public static string[] RareTattoosNames = { Tattoos[2], Tattoos[3], Tattoos[5], Tattoos[8], Tattoos[14], Tattoos[15], Tattoos[16], Tattoos[18], Tattoos[19], Tattoos[24], Tattoos[30], Tattoos[32], Tattoos[33], Tattoos[34], Tattoos[35], Tattoos[36], Tattoos[38], Tattoos[42], Tattoos[46] };
    ...
    public static Tattoo DebugTattoo = GetTattooFromName("Blood Eye");
