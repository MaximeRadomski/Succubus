...
public static class TattoosData
{
    ...
    /* 90 */ "Podium", "Whac-A-Mole", "Dark Sign", "Gamegirl", "Stairway to Heaven", "Brobot", "King of Clubs", "Raccoon" };
    ...
    public static Tattoo DebugTattoo = GetTattooFromName("Slumbering Dragoncrest");
