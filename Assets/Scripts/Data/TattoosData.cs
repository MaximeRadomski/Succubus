...
public static class TattoosData
{
    ...
    public static string[] Tattoos =
        ...
        "Eclipse Glasses", "Crown Of Thorns", "Perfect Score", "Heavy Weight", "Ouroboros", "SOP Sign" };
    ...
    public static string[] LegendaryTattoosNames = { Tattoos[6], Tattoos[7], Tattoos[22], Tattoos[23], Tattoos[25] };

    //DEBUG
    public static bool DebugEnabled = false;
    public static Tattoo DebugTattoo = GetTattooFromName("SOP Sign");
