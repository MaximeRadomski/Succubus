...
public static class ItemsData
{
    ...
    /* 20 */ "The Hierophant", "Eliacube", "Mask of Duality", "Door of Truth", "Sun Juice", "Death Scythe" };

    public static string[] CommonItemsNames = { Items[0], Items[1], Items[2], Items[3], Items[8], Items[11], Items[12], Items[16], Items[17], Items[21], Items[22] };
    ...
    public static Item DebugItem = GetItemFromName("Death Scythe");
