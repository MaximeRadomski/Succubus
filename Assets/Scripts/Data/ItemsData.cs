...
public static class ItemsData
{
    ...
    /* 10 */ "Justice Shovel", "Flipping Coin", "D6", "Mold Fashioned", "Lucky Ladybug", "Knight Shield", "CRT Monitor", "Creeping Totem", "The Devil" };

    public static string[] CommonItemsNames = { Items[0], Items[1], Items[2], Items[3], Items[8], Items[11], Items[12], Items[16], Items[17] };
    public static string[] RareItemsNames = { Items[4], Items[5], Items[9], Items[10], Items[13], Items[14], Items[15], Items[18] };
    public static string[] LegendaryItemsNames = { Items[6], Items[7] };

    //DEBUG
    public static bool DebugEnabled = true;
    public static Item DebugItem = GetItemFromName("The Devil");
