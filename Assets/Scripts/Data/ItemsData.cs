...
public static class ItemsData
{
    ...
    /* 20 */ "The Hierophant", "Eliacube" };

    public static string[] CommonItemsNames = { Items[0], Items[1], Items[2], Items[3], Items[8], Items[11], Items[12], Items[16], Items[17], Items[21] };
    ...
    public static Item DebugItem = GetItemFromName("Eliacube");
